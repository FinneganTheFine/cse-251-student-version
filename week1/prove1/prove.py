...
def run_with_threads(tur, log, main_turtle):
    ...
    t1 = threading.Thread(target = thread_func, args=(tur, draw_squares, lock))
    t2 = threading.Thread(target = thread_func, args=(tur, draw_circles, lock))
    t3 = threading.Thread(target = thread_func, args=(tur, draw_triangles, lock))
    t4 = threading.Thread(target = thread_func, args=(tur, draw_rectangles, lock))
